 ...
 <b>  必备条件</b><br>
   ...
   开发MeowMusicServer项目的团队同时提供了小智源码调用其音乐服务器播放音乐的源码项目。但似乎不太会修改小智共享项目，不会优化ESP32S3的IDF代码环境播放在线音乐算法，编译出来的小智固件源码解析播放在线音乐效果很差劲。要么播不到半分钟停工，声音卡顿，播放中复位重启，几乎播放每首歌都如此。<br>
