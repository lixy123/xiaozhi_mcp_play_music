...
1.ESP32S3<br/>
  ...
  因为播放mp3用的ESP32-audioI2S库必须用到PSRAM，同时这个语音库不支持 ESP32-S2、ESP32-C3 等单核芯片。 <br/>
...
B.下载编译好的固件: （已上传至：Releases) <br>
注：编译了esp32，esp32s3, esp32c5 三种固件，找到你芯片对应的固件进行下载，我只测试了esp32s3的固件 <br>
C. 固件烧录地址： 0x0<br>
